...
use crate::{
    curve::swap_curve::get_swap_curve_result,
    math::fees::Fees,
...
use super::{
    account_meta_from_goat_swap::GoatTokenSwap,
    state::{AmmConfig, PoolState},
};
...
impl GoatSwapAmm {
    ...
    fn get_quote_swap_base_input(&self, quote_params: &QuoteParams) -> Result<Quote> {
        ...
        let (input_mint_account, output_mint_account, swap_source_amount, swap_destination_amount) = {
